/** Shared HTTP security headers for Next.js `headers()` config. */

const contentSecurityPolicy = [
  "default-src 'self'",
  // Next.js, Vercel Analytics/Speed Insights (same-origin scripts), Paystack checkout, optional GA/PostHog
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.paystack.co https://*.paystack.co https://www.googletagmanager.com https://www.google-analytics.com https://*.i.posthog.com https://us.i.posthog.com https://eu.i.posthog.com https://vercel.live",
