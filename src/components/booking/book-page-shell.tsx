  ...
  return (
    <div className="relative -mt-[calc(var(--header-height)+env(safe-area-inset-top,0px))] min-h-[100svh] overflow-hidden bg-glam-primary">
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-glam-primary/80 via-glam-primary/65 to-glam-primary/88" />
        <div className="absolute inset-0 bg-gradient-to-r from-glam-primary/50 via-transparent to-glam-primary/50" />
      </div>
